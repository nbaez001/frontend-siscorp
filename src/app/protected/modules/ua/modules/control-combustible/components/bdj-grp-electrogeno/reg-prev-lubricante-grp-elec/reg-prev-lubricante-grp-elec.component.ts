...
import { PRODUCTOSLUBRICANTE, UNIDADES, TAMBOS, generadores } from '../../../data-combustible'
...
@Component({
  selector: 'app-reg-prev-lubricante-grp-elec',
  templateUrl: './reg-prev-lubricante-grp-elec.component.html',
  styleUrls: ['./reg-prev-lubricante-grp-elec.component.scss']
})
export class RegPrevLubricanteGrpElecComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    public dialogRef: MatDialogRef<RegPrevLubricanteGrpElecComponent>,
