...
export class ProyectoVisualizarCgpComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,public dialogRef: MatDialogRef<ProyectoVisualizarCgpComponent>,
