...
import { WsResponseValor } from '../dto/ValorResponse';
...
export class TrabajadorService {
  ...
  listarTrabajadorAutorizacionGasto(pagina: number, cantidad: number, filtrosProyectoRequest): Observable<WsResponseTrabajador> {
    // return this.http.get<WsResponseProyecto>('assets/trabajador.json');
    return this.http.post<WsResponseTrabajador>(`${environment.backendUrlProj}/autorizacionGastoTrabajador/listarTrabajadorAutorizacionGasto/${pagina}/${cantidad}`, filtrosProyectoRequest);
  }

  registrarTrabajadorAutorizacionGasto(parametroGeneral,trabajador): Observable<any> {
    // return this.http.get<WsResponseProyecto>('assets/trabajador.json');
    return this.http.post<any>(`${environment.backendUrlProj}/autorizacionGastoTrabajador/registrarTrabajadorAutorizacionGasto`, parametroGeneral,trabajador);
  }
  ...
  obtenerTipoDocumento(): Observable<WsItemBeanResponse> {
    ...
    // return this.http.get<WsItemBeanResponse>(`${environment.backendUrlProj}/autorizacionGastoTrabajador/listarTiposDocs`);
  }
  ...
  obtenerDataWsReniec(numero: string): Observable<Reniec> {
    ...
    // return this.http.get<any>(`http://www.pais.gob.pe/sismonitor/utilitarios/webserviceReniec2/dni/${numero}`);
    
  }

  /**WHR INICIO**/
  obtenerMontosJornal(parametros): Observable<any> {
    return this.http.post<any>(`${environment.backendUrlProj}/autorizacionGastoTrabajador/obtenerMontosJornal`, parametros);
  }
